...
class Config:
    ...
    TRADING_PAIRS: List[str] = os.getenv(
        'TRADING_PAIRS', 
        'BTCUSDT,ETHUSDT,BNBUSDT,XRPUSDT,SOLUSDT,DOGEUSDT,ADAUSDT,HYPEUSDT,LINKUSDT,XMRUSDT,XLMUSDT,LTCUSDT,AVAXUSDT,SUIUSDT,ZECUSDT,HBARUSDT,SHIBUSDT,TONUSDT,CROUSDT,DOTUSDT,UNIUSDT,BGBUSDT,TAOUSDT,AAVEUSDT,PEPEUSDT,ONDOUSDT,POLUSDT,APTUSDT,QNTUSDT,FILUSDT,RENDERUSDT,VETUSDT,ARBUSDT,XDCUSDT,JUPUSDT,NEARUSDT,SEIUSDT'
    ).split(',')

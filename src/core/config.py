...
class Config:
    ...
    TRADING_PAIRS: List[str] = [
        pair.strip() for pair in os.getenv(
            'TRADING_PAIRS', 
            'BTCUSDT, ETHUSDT, BNBUSDT, XRPUSDT, SOLUSDT, TRXUSDT, DOGEUSDT, ADAUSDT, HYPEUSDT, LINKUSDT, XMRUSDT, XLMUSDT, LTCUSDT, AVAXUSDT, SUIUSDT, ZECUSDT, HBARUSDT, SHIBUSDT, TONUSDT, CROUSDT, DOTUSDT, UNIUSDT, BGBUSDT, TAOUSDT, AAVEUSDT, PEPEUSDT, ONDOUSDT, POLUSDT, APTUSDT, ALGOUSDT, QNTUSDT, FILUSDT, RENDERUSDT, VETUSDT, ARBUSDT, XDCUSDT, JUPUSDT'
        ).split(',')
    ]
    ...
    CORRELATION_GROUPS = {
        ...
        'layer1': ['TRXUSDT','TONUSDT','APTUSDT','TAOUSDT','QNTUSDT','XDCUSDT',],  # L1 platforms
